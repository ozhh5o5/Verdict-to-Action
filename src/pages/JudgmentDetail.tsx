...
import { Calendar, Scale, CheckCircle2, ShieldAlert, ArrowLeft, Lightbulb, AlertTriangle, Crosshair, FileText, Scale as ScaleIcon } from 'lucide-react'
...
export default function JudgmentDetail() {
  ...
  const handleVerify = (obligationId: string, currentVerified: boolean) => {
    // In Vite SPA, we just update local state
    if (judgment) {
      setJudgment({
        ...judgment,
                  ...
                  {filteredObligations.map(obligation => (
                    ...
                    >
                      ...
                      <div className="mt-4 pt-3 border-t border-slate-800 flex justify-between items-center">
                        ...
                        <Link to={`/obligations/${obligation.id}`} onClick={(e: React.MouseEvent) => e.stopPropagation()}>
                      ...
                      <div key={i} className="border border-slate-800 rounded-lg overflow-hidden bg-slate-950/50">
                        <div className="bg-slate-900 border-b border-slate-800 p-4">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <Link to={`/obligations/${group.obligation.id}`} className="text-white font-medium hover:underline leading-snug">
                              ...
                              <AlertDescription className="mt-3 space-y-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                                  <div className="bg-slate-950 p-3 rounded border border-slate-800">
                                    ...
                                    <div className="text-sm italic text-slate-400">"{conflict.description}"</div>
                                  </div>
                                  <div className="bg-slate-950 p-3 rounded border border-slate-800">
