...
import { ShieldAlert, Scale as ScaleIcon, AlertTriangle, TrendingUp, ArrowLeft, FileText } from 'lucide-react'
...
export default function ContemptRisk() {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <Link to="/contempt-risk" className="px-3 py-2 rounded-md text-sm font-medium text-white bg-slate-800 transition-colors">Contempt Risk</Link>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <Link to={`/judgments/${risk.judgmentId}`} className="hover:underline">
